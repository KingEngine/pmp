...
public class MerInfo implements java.io.Serializable{
  ...
  private int beginDate;/*对应表中begin_date*/
  private int expDate;/*对应表中exp_date*/
  ...
  private int credentialsStartDate;/*对应表中credentials_start_date*/
  private int credentialsEndDate;/*对应表中credentials_end_date*/
  ...
  private Date updateTime;/*对应表中update_time*/
  ...
  private int busStartDate;/*对应表中bus_start_date*/
  private int busEndDate;/*对应表中bus_end_date*/
  ...
  private String merManagerName;/*对应表中mer_manager_name*/
    ...
    public int getCredentialsStartDate(){  
      return credentialsStartDate;  
    }  
    public void setCredentialsStartDate(int credentialsStartDate){  
      this.credentialsStartDate = credentialsStartDate;  
    }  
    public int getCredentialsEndDate(){  
      return credentialsEndDate;  
    }  
    public void setCredentialsEndDate(int credentialsEndDate){  
    ...
    public int getBusStartDate(){  
      return busStartDate;  
    }  
    public void setBusStartDate(int busStartDate){  
      this.busStartDate = busStartDate;  
    }  
    public int getBusEndDate(){  
      return busEndDate;  
    }  
    public void setBusEndDate(int busEndDate){  
