...
public class Tlog implements java.io.Serializable {
	private static final long serialVersionUID = 1658461474352402928L;
	...
	private Timestamp xpepDeductSysTime;/* 对应表中xpep_deduct_sys_time */
	private Timestamp xpepDeductStlmDate;/* 对应表中xpep_deduct_stlm_date */
	...
	private String abbrev;//商户简称、页面显示
	private String gisaddr;//基站信息
	...
	public Timestamp getXpepDeductSysTime() {
		return xpepDeductSysTime;
	}

	public void setXpepDeductSysTime(Timestamp xpepDeductSysTime) {
		this.xpepDeductSysTime = xpepDeductSysTime;
	}

	public Timestamp getXpepDeductStlmDate() {
		return xpepDeductStlmDate;
	}

	public void setXpepDeductStlmDate(Timestamp xpepDeductStlmDate) {
