...
if(IE) document.getElementById('softkeyboard').style.pixelTop += percent;
if(NS) document.getElementById('softkeyboard').top += percent; 
lastScrollY = lastScrollY + percent;}
if(diffX != lastScrollX) {
percent = .1 * (diffX - lastScrollX);
if(percent > 0) percent = Math.ceil(percent);
else percent = Math.floor(percent);
if(IE) document.getElementById('softkeyboard').style.pixelLeft += percent;
if(NS) document.getElementById('softkeyboard').left += percent;
