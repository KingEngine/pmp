...
<body >
	<div class="easyui-panel" title="查询区" style="width: 100%;">
                ...
                <tr>
	              ...
	              <tr>
	                <td colspan="4" align="center">
		                ...
		                &nbsp;&nbsp;
		                 <a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="showDialogWithOutParameter('getOperatorAddPre.do','操作员新增',800,'addOperatorDialog');">新增</a>
		                &nbsp;&nbsp;
	...
	<div class="easyui-panel" id="AAA" style="margin-top: 10px;width: 100%;" data-options="closed:true">
